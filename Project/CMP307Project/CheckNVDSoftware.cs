...
{
    public partial class CheckNVDSoftware : Form
    {
        ...
        public CheckNVDSoftware()
        {
            InitializeComponent();
        }

        public CheckNVDSoftware(User u)     //passing through user who is logged in
        {
            InitializeComponent();
            user = u;
        }
        ...
        private void checkButton_Click(object sender, EventArgs e)
        {
            ...
            if ((dataGridView2.SelectedRows.Count > 0))         //checking that an asset has been selected
            {
                ...
                int columnindex = dataGridView2.Columns.Count - 10;     //Getting the software name location from column
                ...
                {
                    MessageBox.Show("There were no vulnerabilities found for this software at this severity level");
                }
            ...
            {
                MessageBox.Show("Please select an asset (software)");
            }
        }
        ...
        private void assetText_TextChanged(object sender, EventArgs e)          //Filtering the datagridview to change based on what is in the text box
        {
            ...
            dv.RowFilter = "sname LIKE '" + assetText.Text + "%'";
            dataGridView2.DataSource = dv;
        }

        private void lowButton_Click(object sender, EventArgs e)        //when low button clicked, turn all others to false and low to true
        {
            low = true;
            medium = false;
            high = false;
        ...
        private void CheckNVDSoftware_Load(object sender, EventArgs e)
        {
